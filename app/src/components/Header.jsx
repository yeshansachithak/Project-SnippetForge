        ...
        <header
            ...
            <div className="max-w-7xl mx-auto px-2 sm:px-4">
                ...
                <div className="text-center">
                    ...
                    <p className="mt-1 sm:mt-2 text-xs sm:text-sm text-gray-500 dark:text-gray-400 tracking-wide">
                ...
                <div className="mt-4">
                    <input
                        ...
                        className="w-full p-3 border rounded text-sm sm:text-base dark:bg-gray-800 dark:text-white dark:border-gray-600"
                    />
                </div>

                {/* Filter Tags */}
                <div className="flex gap-2 flex-wrap overflow-x-auto py-2 px-1 scrollbar-hide">
                    {allConcepts.map((concept) => (
                        <button
                            ...
                            className={`text-xs px-3 py-1 rounded-full border transition shrink-0 hover:scale-[1.03] ${
